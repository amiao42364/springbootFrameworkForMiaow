...
import cn.miaow.framework.exception.user.CaptchaException;
import cn.miaow.framework.exception.user.CaptchaExpireException;
...
public class SysRegisterService {
    ...
    public SysRegisterService(SysUserServiceImpl userService, SysConfigServiceImpl configService, RedisCache redisCache) {
    ...
    public String register(RegisterBody registerBody) {
        ...
        } else if (userService.checkUserNameNotUnique(sysUser)) {
