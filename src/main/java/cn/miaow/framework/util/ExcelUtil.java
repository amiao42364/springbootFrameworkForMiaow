...
import cn.miaow.framework.aspectj.annotation.Excel.ColumnType;
import cn.miaow.framework.aspectj.annotation.Excel.Type;
import cn.miaow.framework.aspectj.annotation.Excels;
import cn.miaow.framework.config.MiaowConfig;
import cn.miaow.framework.exception.UtilException;
import cn.miaow.framework.model.AjaxResult;
import cn.miaow.framework.util.file.FileTypeUtils;
import cn.miaow.framework.util.file.FileUtils;
import cn.miaow.framework.util.file.ImageUtils;
import cn.miaow.framework.util.poi.ExcelHandlerAdapter;
import cn.miaow.framework.util.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public String dataFormatHandlerAdapter(Object value, Excel excel) {
        try {
            ...
            log.error("不能格式化数据{}, 异常:{} " , excel.handler(), e.getMessage());
        }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = MiaowConfig.getDownloadPath() + filename;
    ...
    public boolean isSubListValue(T vo) {
        return StringUtils.isNotNull(subFields) && !subFields.isEmpty()
                && StringUtils.isNotNull(getListCellValue(vo)) && !getListCellValue(vo).isEmpty();
    }
