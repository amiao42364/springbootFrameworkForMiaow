...
import cn.miaow.framework.exception.file.FileNameLengthLimitExceededException;
import cn.miaow.framework.exception.file.FileSizeLimitExceededException;
import cn.miaow.framework.exception.file.InvalidExtensionException;
import cn.miaow.framework.util.DateUtils;
import cn.miaow.framework.util.StringUtils;
import cn.miaow.framework.util.uuid.Seq;
...
public class FileUploadUtils {
     ...
     */
    @Getter
    private static String defaultBaseDir = MiaowConfig.getProfile();
    ...
    public static String getPathFileName(String uploadDir, String fileName) {
        int dirLastIndex = MiaowConfig.getProfile().length() + 1;
